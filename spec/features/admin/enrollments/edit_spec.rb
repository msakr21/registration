...
RSpec.describe 'edit enrollment page', type: :feature, driver: :selenium_chrome, js: true do
  let!(:eloise_may) { Enrollment.create(location: 'Eloise May', schedule: DateTime.parse('2030-06-10T15:00:24.000Z'), student_limit: 30) }
  ...
  it 'redirects to the adminenrollments index page after updating' do
    visit "/admin/enrollments/#{eloise_may.id}/edit"
