...
const ListLocationEnrollments = (user, enrollments, deletePath, setDeletePath, deleteMessage, setDeleteMessage, displayConfirmationModal, setDisplayConfirmationModal) => { return enrollments.map((enrollment) =>
  <Col key={enrollment.id}>
    <Card className="enrollment-card" bg="light" text="dark" border="dark">
      <Card.Body style={{ textAlign: "center" }}>
        ...
        <br />
        {UserListUI(user, enrollment, deletePath, setDeletePath, deleteMessage, setDeleteMessage, displayConfirmationModal, setDisplayConfirmationModal)}
      </Card.Body>
    </Card>
  </Col>
)};
